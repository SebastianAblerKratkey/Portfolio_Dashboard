...
if download_sucess:
    ...
    if option == "Call Options":
        ...
        default_black_scholes_value = black_scholes_call_value(S0=spot_price, K=strike_price, rf=rf, T=time_in_years, vol=(return_data.std() * (trading_days_per_year)**0.5)) * subscription_ratio
